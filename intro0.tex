...
\caption{An uncased Raspberry Pi 2. The numbered connectors are \protect\circled{1} HDMI output,  \protect\circled{2} four USB ports,  \protect\circled{4} micro-USB power input,  \protect\circled{5} a red power LED and a green `activity' LED,  \protect\circled{6} stereo audio out,  \protect\circled{7} General Purpose Input/Output (GPIO),  \protect\circled{8} Ethernet.}\label{figure:bare-rpi}
\end{figure}
