...
screen press \ttout{space} you will need to respond. Meanwhile, be
...
\wikipedia{Mac_os_9}{Mac OS 9}) in favour of a Unix-based system (now
...
Swedish programmer \wikipedia{Linus_torvalds}{Linus Torvalds} of a
...
known as the \wikipedia{Linux_kernel}{Linux Kernel}. Combined with
other free software created by the
\wikipedia{Free_software_foundation}{Free Software Foundation}, a
non-commercial version of Unix called \wikipedia{GNU/Linux}{GNU/Linux}
