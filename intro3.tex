...
\courseunit{COMP18112}. In the terminal, type \ctrl{c} to stop the webserver.
...
Change directory to the \fname{htmlexample2} directory you created for
...
\fname{/var/www} and any files or directories in it to add write access
...
\cmnd{sudo halt}{halt} command to shut your Pi down cleanly, otherwise you
